...
window.switchTab = window.switchTab || function(e) {
    ...
    if (window.innerWidth <= 1024) {
        const sb = document.querySelector('.aff-sidebar');
        const ov = document.querySelector('.aff-sidebar-overlay');
